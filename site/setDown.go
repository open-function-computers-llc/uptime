...
func (s *Website) setSiteDown(dbConn *storage.Connection, secondsDown int, errMessage string) {
	if s.IsUp {
	...
	s.Logger.Info(s.URL + " has been down for at least " + strconv.Itoa(secondsDown) + " second(s), " + errMessage)
